//! 真机冒烟：cargo run -p kumodeck-providers --example smoke_bili -- <BV号或链接>
use kumodeck_core::models::{Quality, VideoDownloadRequest};
...
async fn main() -> anyhow::Result<()> {
    let dir = std::env::temp_dir().join("kumodeck-smoke-bili");
