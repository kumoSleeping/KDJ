//! 真机冒烟：cargo run -p kumodeck-providers --example smoke_netease -- <关键词>
use kumodeck_core::models::Quality;
use kumodeck_providers::{netease::NeteaseProvider, MusicProvider, ProviderContext};

#[tokio::main]
async fn main() -> anyhow::Result<()> {
    let dir = std::env::temp_dir().join("kumodeck-smoke");
